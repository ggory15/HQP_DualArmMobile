...
public:
	...
	void reset(Indexnum dim_qp, Indexnum num_eq, Indexnum num_ineq);
	...
	*/
	Indexnum getActiveSetSize() const { return q; }
...
private:
	...
	inline bool add_constraint(MatrixXd & R,
		MatrixXd & J,
		VectorXd & d,
		Indexnum& iq, double& R_norm);

	inline void delete_constraint(MatrixXd & R,
		MatrixXd & J,
		VectorXi & A,
		VectorXd & u,
		Indexnum nEqCon, Indexnum& iq,
		Indexnum l);
};
