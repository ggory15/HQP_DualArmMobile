#ifndef __HQP__Constraint__EQUALITY__
#define __HQP__Constraint__EQUALITY__
...
namespace HQP {
	namespace constraint {
		...
		public:
			...
			ConstraintEquality(const std::string & name, Cref_matrixXd A, Cref_vectorXd b);
...
#endif // __HQP__Constraint__EQUALITY__